...
{
    public class WorkerValidator : AbstractValidator<EmployeeWorker>
    {
        public WorkerValidator()
        {
            RuleFor(x => x.EmployeeFirstname)
                ...
                .MinimumLength(2).WithMessage("25 Karakterden fazla olmalıdır.");
            ...
            RuleFor(x => x.EmployeeBirthPlace).NotEmpty().WithMessage("Boş Bırakılmamalı.")
                .MaximumLength(50).WithMessage("50 Karakterden az olmalıdır.")
                .MinimumLength(4).WithMessage("4 Karakterden fazla olmalıdır.");

            RuleFor(x => x.EmployeeAdress1).NotEmpty().WithMessage("Boş Bırakılmamalı.")
                .MaximumLength(50).WithMessage("50 Karakterden az olmalıdır.")
